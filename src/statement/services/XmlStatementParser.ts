 ...
 *   </operations>`
 */
export class XmlStatementParser implements StatementParser {
   ...
   */
  private parseOperation(op: any): Transaction {
  ...
  private parseMoneyNode(
    ...
    const curr = ((node?.curr ?? fallbackCurrency ?? "PLN") as Currency).toString() as Currency;
